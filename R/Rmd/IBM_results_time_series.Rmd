...
load("C:/LEHOUX/Maquereau/iml-mackerel/03.0_egg-index/results/2024/spawning/predicted_propspawn_doy2024.RData")
spawn<- read.delim("C:/LEHOUX/Maquereau/iml-mackerel/03.0_egg-index/results/2024/spawning/table_nlmeAR_2024.txt")
...
rec<- read.csv("C:/LEHOUX/Maquereau/iml-mackerel/00.0_model/csv/2024/rec.csv") %>%  filter(year >=1999) %>%  rename(Recruitment= Estimate)
...
ssb_eval<- read.csv("C:/LEHOUX/Maquereau/iml-mackerel/00.0_model/csv/2024/ssb.csv") %>%  filter(year >=1999) %>%  rename(SSB= Estimate)
